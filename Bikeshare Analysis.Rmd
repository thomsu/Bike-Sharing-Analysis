...
This is further confirmation that station_id 0 is not at some specific location.

The following 2 code chunks check to see if there are any station_id that is not 0 or missing that has empty string for station_name
